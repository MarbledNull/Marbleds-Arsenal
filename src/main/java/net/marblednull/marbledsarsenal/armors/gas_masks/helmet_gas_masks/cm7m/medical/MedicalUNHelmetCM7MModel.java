...
public class MedicalUNHelmetCM7MModel extends AnimatedGeoModel<MedicalUNHelmetCM7MArmorItem> {
    @Override
    public ResourceLocation getModelResource(MedicalUNHelmetCM7MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "geo/helmet_cm7m.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MedicalUNHelmetCM7MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "textures/armor/medical_un_helmet_cm7m.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MedicalUNHelmetCM7MArmorItem object) {
