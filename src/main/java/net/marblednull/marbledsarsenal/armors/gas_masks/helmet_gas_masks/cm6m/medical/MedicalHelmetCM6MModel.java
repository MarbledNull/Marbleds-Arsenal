...
public class MedicalHelmetCM6MModel extends AnimatedGeoModel<MedicalHelmetCM6MArmorItem> {
    @Override
    public ResourceLocation getModelResource(MedicalHelmetCM6MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "geo/helmet_cm6m.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MedicalHelmetCM6MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "textures/armor/medical_helmet_cm6m.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MedicalHelmetCM6MArmorItem object) {
