...
public class MedicalUNHelmetCM6MModel extends AnimatedGeoModel<MedicalUNHelmetCM6MArmorItem> {
    @Override
    public ResourceLocation getModelResource(MedicalUNHelmetCM6MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "geo/helmet_cm6m.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MedicalUNHelmetCM6MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "textures/armor/medical_un_helmet_cm6m.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MedicalUNHelmetCM6MArmorItem object) {
