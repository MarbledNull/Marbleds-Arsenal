...
public class UNHelmetCM7MModel extends AnimatedGeoModel<UNHelmetCM7MArmorItem> {
    @Override
    public ResourceLocation getModelResource(UNHelmetCM7MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "geo/helmet_cm7m.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(UNHelmetCM7MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "textures/armor/un_helmet_cm7m.png");
    }

    @Override
    public ResourceLocation getAnimationResource(UNHelmetCM7MArmorItem object) {
