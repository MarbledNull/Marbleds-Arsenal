...
public class CM7MModel extends AnimatedGeoModel<CM7MArmorItem> {
    @Override
    public ResourceLocation getModelResource(CM7MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "geo/cm7m.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CM7MArmorItem object) {
        return new ResourceLocation(MarbledsArsenal.MODID, "textures/armor/cm7m.png");
    }

    @Override
    public ResourceLocation getAnimationResource(CM7MArmorItem object) {
