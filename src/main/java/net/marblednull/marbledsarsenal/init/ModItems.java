...
public class ModItems {
    ...
    public static final RegistryObject<Item> MANGROVE_GHILLIE_HELMET = ITEMS.register("mangrove_ghillie_helmet", () -> new MangroveGhillieArmorItem(MaArmorMaterials.GHILLIE, EquipmentSlot.HEAD, new Item.Properties().tab(ModTabs.MARBLEDS_ARSENAL)));
    public static final RegistryObject<Item> MANGROVE_GHILLIE_CHESTPLATE = ITEMS.register("mangrove_ghillie_chestplate", () -> new MangroveGhillieArmorItem(MaArmorMaterials.GHILLIE, EquipmentSlot.CHEST, new Item.Properties().tab(ModTabs.MARBLEDS_ARSENAL)));
    public static final RegistryObject<Item> MANGROVE_GHILLIE_LEGGINGS = ITEMS.register("mangrove_ghillie_leggings", () -> new MangroveGhillieArmorItem(MaArmorMaterials.GHILLIE, EquipmentSlot.LEGS, new Item.Properties().tab(ModTabs.MARBLEDS_ARSENAL)));
    public static final RegistryObject<Item> MANGROVE_GHILLIE_BOOTS = ITEMS.register("mangrove_ghillie_boots", () -> new MangroveGhillieArmorItem(MaArmorMaterials.GHILLIE, EquipmentSlot.FEET, new Item.Properties().tab(ModTabs.MARBLEDS_ARSENAL)));
