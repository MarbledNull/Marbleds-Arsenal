...
import net.marblednull.marbledsarsenal.client.renderer.PoliceArmorRenderer;
...
public class PoliceArmorItem extends ArmorItem implements GeoItem {
    ...
    public PoliceArmorItem(ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
