...
public class BlackPlateCarrierArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public BlackPlateCarrierArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.plate_carrier.idle", true));
        ...
        boolean isWearingAll = armorList
                .containsAll(Arrays.asList(ModItems.BLACK_PLATE_CARRIER_T1.get(), ModItems.BLACK_PLATE_CARRIER_T2.get(),
                        ModItems.BLACK_PLATE_CARRIER_T3.get()));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new
                AnimationController<BlackPlateCarrierArmorItem>
