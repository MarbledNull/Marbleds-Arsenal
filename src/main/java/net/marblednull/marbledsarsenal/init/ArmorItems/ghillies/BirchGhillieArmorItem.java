...
import net.marblednull.marbledsarsenal.armors.ghillie.BirchGhillieArmorRenderer;
...
public class BirchGhillieArmorItem extends ArmorItem implements GeoItem {
    ...
    public BirchGhillieArmorItem(ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
