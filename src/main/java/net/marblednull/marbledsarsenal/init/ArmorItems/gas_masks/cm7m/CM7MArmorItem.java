...
import net.marblednull.marbledsarsenal.client.gas_masks.cm7m.CM7MRenderer;
...
public class CM7MArmorItem extends ArmorItem implements GeoItem {
    ...
    private PlayState predicate(AnimationState animationState) {
        animationState.getController().setAnimation(RawAnimation.begin().then("animation.cm7m.idle", Animation.LoopType.LOOP));
