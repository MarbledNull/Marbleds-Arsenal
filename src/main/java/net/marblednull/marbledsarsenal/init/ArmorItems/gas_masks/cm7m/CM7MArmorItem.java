...
public class CM7MArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public CM7MArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList
                .containsAll(Arrays.asList(ModItems.CM7M_GAS_MASK.get()));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new
                AnimationController<CM7MArmorItem>
