...
public class FloweringAzeleaGhillieArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public FloweringAzeleaGhillieArmorItem(ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
