...
public class CM8MArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public CM8MArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.cm8m.idle", true));
