...
public class UNHelmetCM6MArmorItem extends GeoArmorItem implements IAnimatable {
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public UNHelmetCM6MArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList
                .containsAll(Arrays.asList(ModItems.UN_HELMET_CM6M_GAS_MASK.get()));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new
                AnimationController<UNHelmetCM6MArmorItem>
