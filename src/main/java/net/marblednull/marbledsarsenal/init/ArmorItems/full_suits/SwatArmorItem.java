...
public class SwatArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public SwatArmorItem(ArmorMaterial materialIn, EquipmentSlot slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.swat_armor.idle", ILoopType.EDefaultLoopTypes.LOOP));
