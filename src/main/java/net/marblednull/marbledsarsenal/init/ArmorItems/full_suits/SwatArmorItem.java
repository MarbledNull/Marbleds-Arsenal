...
public class SwatArmorItem extends GeoArmorItem implements IAnimatable {
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public SwatArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.swat_armor.idle", true));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new
                AnimationController<SwatArmorItem>
