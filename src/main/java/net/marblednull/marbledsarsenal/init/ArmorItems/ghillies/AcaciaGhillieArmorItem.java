...
import net.marblednull.marbledsarsenal.armors.ghillie.AcaciaGhillieArmorRenderer;
...
public class AcaciaGhillieArmorItem extends ArmorItem implements GeoItem {
    ...
    public AcaciaGhillieArmorItem(ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
