...
public class HelmetCM6MArmorItem extends GeoArmorItem implements IAnimatable {
    public AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public HelmetCM6MArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new
                AnimationController<HelmetCM6MArmorItem>
