...
public class HazmatArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList
                .containsAll(Arrays.asList(ModItems.HAZMAT_ARMOR_HELMET.get(), ModItems.HAZMAT_ARMOR_CHESTPLATE.get(),
                        ModItems.HAZMAT_ARMOR_LEGGINGS.get(), ModItems.HAZMAT_ARMOR_BOOTS.get()));
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new
                AnimationController<HazmatArmorItem>
