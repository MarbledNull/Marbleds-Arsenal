...
public class MedicalHelmetCM7MArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public MedicalHelmetCM7MArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList
                .containsAll(Arrays.asList(ModItems.HELMET_CM6M_GAS_MASK.get()));
