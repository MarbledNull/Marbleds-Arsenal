...
import net.marblednull.marbledsarsenal.client.ghillie.CherryGhillieArmorRenderer;
...
public class CherryGhillieArmorItem extends ArmorItem implements GeoItem {
    ...
    public CherryGhillieArmorItem(ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
