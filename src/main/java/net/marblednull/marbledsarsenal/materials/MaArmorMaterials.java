...
public enum MaArmorMaterials implements ArmorMaterial {
    ...
    PLATE_CARRIER_HEAVY("plate_carrier_heavy", 20, new int[]{2, 8, 5, 2}, 15,
            SoundEvents.ARMOR_EQUIP_IRON, 1.5f, 0.1f, () ->
            Ingredient.of(ModItems.STEEL_INGOT.get())),

    GAS_MASK("gas_mask", 15, new int[]{1, 6, 5, 2}, 15,
                SoundEvents.ARMOR_EQUIP_IRON, 0f, 0f, () ->
            Ingredient.of(ModItems.STEEL_INGOT.get())),

    HAZMAT("hazmat", 13, new int[]{1, 3, 2, 1}, 15,
            SoundEvents.ARMOR_EQUIP_LEATHER, 0f, 0f, () ->
            Ingredient.of(new ItemLike[]{Items.LEATHER})),
    GHILLIE("ghillie", 10, new int[]{1, 3, 2, 1}, 15,
            SoundEvents.ARMOR_EQUIP_LEATHER, 0f, 0f, () ->
            Ingredient.of(new ItemLike[]{Items.LEATHER})),

    POLICEFORCE("policeforce", 25, new int[]{3, 7, 5, 3}, 15,
            SoundEvents.ARMOR_EQUIP_IRON, 2f, 0.1f, () ->
            Ingredient.of(ModItems.STEEL_INGOT.get())),

    MILITARY("military", 33, new int[]{3, 8, 6, 3}, 15,
            SoundEvents.ARMOR_EQUIP_IRON, 2f, 0.1f, () ->
            Ingredient.of(ModItems.STEEL_INGOT.get())),

    JUGGERNAUT("juggernaut", 37, new int[]{3, 9, 7, 3}, 15,
